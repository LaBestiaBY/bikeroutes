...
define('fb',['firebase', 'module', 'eventManager'], function (firebase, module, eventManager) {
...
define('modules/ratingManager',['eventManager', 'fb'], function (eventManager, fb) {
...
define('text!modules/../../../html_templates/tmpl_geoobject_info_window.html',[],function () { return '<div class="modal" id="geoobject_info_window">\r\n    <div class="modal-background"></div>\r\n    <div class="modal-card">\r\n        <header class="modal-card-head">\r\n            <p class="modal-card-title" id="title"></p>\r\n            <button class="delete" id="close-button"></button>\r\n        </header>\r\n        <section class="modal-card-body">\r\n\r\n\r\n            <article class="media">\r\n                <figure class="media-left">\r\n                    <p class="image is-128x128">\r\n                        <img src="http://bulma.io/images/placeholders/128x128.png">\r\n                    </p>\r\n                </figure>\r\n                <div class="media-content">\r\n                    <div class="content">\r\n                        <p id="description">\r\n                            No description.\r\n                        </p>\r\n                    </div>\r\n                </div>\r\n            </article>\r\n\r\n\r\n        </section>\r\n        <footer class="modal-card-foot">\r\n            Rating&nbsp;\r\n            <% if (user) {%>\r\n                <input type="button" class="button" id="plus-button" value="+" style="width: 50px">\r\n            <% } %>\r\n            <p>\r\n                <!--<strong>25&nbsp;&nbsp;</strong>-->\r\n                <span class="tag is-warning" id="rating">\r\n                </span>\r\n                &nbsp;\r\n            </p>\r\n            <% if (user) {%>\r\n                <input type="button" class="button" id="minus-button" value="-" style="width: 50px">\r\n            <% } %>\r\n        </footer>\r\n    </div>\r\n</div>';});

define('modules/geoObjectInfoWindow',['underscore', 'jquery', 'eventManager', 'fb', 'modules/ratingManager', 'text!../../../html_templates/tmpl_geoobject_info_window.html'],
...
define('modules/map',['ymaps', 'jquery', 'eventManager', 'modules/geoObjectInfoWindow', 'modules/ratingManager'], function (ymaps, $, eventManager, infoWindow, ratingManager) {
...
define('text!modules/../../../html_templates/tmpl_main_menu.html',[],function () { return '<nav class="navbar">\r\n    <div class="navbar-brand">\r\n        <a class="navbar-item" href="">\r\n            <img src="img/logo.png" alt="Bike routes" width="112" height="28">\r\n        </a>\r\n        <div class="navbar-end is-hidden-desktop">\r\n            <div class="navbar-item">\r\n                <div class="field is-grouped">\r\n                    <% if (user) {%>\r\n                        <p class="control">\r\n                            <a class="button sign-out">\r\n                                <span class="icon sign-out">\r\n                                    <i class="fa fa-sign-out sign-out"></i>\r\n                                </span>\r\n                            </a>\r\n                        </p>\r\n                    <% } else {%>\r\n                        <p class="control">\r\n                            <a class="button is-primary sign-in">\r\n                                <span class="icon sign-in">\r\n                                    <i class="fa fa-sign-in sign-in"></i>\r\n                                </span>\r\n                            </a>\r\n                        </p>\r\n                    <% } %>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div id="navMenuExample" class="navbar-menu">\r\n        <div class="navbar-start">\r\n\r\n            <div class="navbar-item has-dropdown is-hoverable">\r\n                <a class="navbar-link ">\r\n                    Маршруты\r\n                </a>\r\n                <div id="routesDropdown" class="navbar-dropdown " data-style="width: 18rem;">\r\n\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="main-bike-route" checked="true">\r\n                                Главная велодорожка\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="simple-bike-route" checked="true">\r\n                                Велодорожки на тротуарах\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n                </div>\r\n            </div>\r\n\r\n            <div class="navbar-item has-dropdown is-hoverable">\r\n                <a class="navbar-link  is-active">\r\n                    Метки\r\n                </a>\r\n                <div class="navbar-dropdown ">\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="bike-service" checked="true">\r\n                                Велосервисы\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="food" checked="true">\r\n                                Питание\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="wc" checked="true">\r\n                                Туалеты\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n\r\n                    <a class="navbar-item ">\r\n                        <p class="control">\r\n                            <label class="checkbox">\r\n                                <input type="checkbox" class="bike-parking" checked="true">\r\n                                Велопарковки\r\n                            </label>\r\n                        </p>\r\n                    </a>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class="navbar-end">\r\n            <div class="navbar-item">\r\n                <div class="field is-grouped">\r\n                    <% if (user) {%>\r\n                        <p class="control">\r\n                            <a class="button sign-out">\r\n                                <span class="icon sign-out">\r\n                                    <i class="fa fa-sign-out sign-out"></i>\r\n                                </span>\r\n                                <span class="sign-out">Sign out</span>\r\n                            </a>\r\n                        </p>\r\n                    <% } else {%>\r\n                        <p class="control">\r\n                            <a class="button is-primary sign-in">\r\n                                <span class="icon sign-in">\r\n                                    <i class="fa fa-sign-in sign-in"></i>\r\n                                </span>\r\n                                <span class="sign-in">Sign in</span>\r\n                            </a>\r\n                        </p>\r\n                    <% } %>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</nav>';});

define('modules/settingsManager',['eventManager', 'fb'], function (eventManager, fb) {
...
define('modules/menu',['underscore', 'jquery', 'text!../../../html_templates/tmpl_main_menu.html', 'eventManager', 'fb', 'modules/settingsManager'],
...
define('modules/dataLoader',['jquery', 'eventManager'], function ($, eventManager) {
...
define('app',['modules/map', 'modules/menu', 'modules/dataLoader', 'modules/geoObjectInfoWindow', 'modules/ratingManager', 'modules/settingsManager', 'fb'],
