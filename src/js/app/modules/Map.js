    ...
    Map.prototype = {
        ...
        render: function () {
                ...
                /*var myIconContentLayout = ymaps.templateLayoutFactory.createClass('<div class="square_layout"></div>');
                 ...
                 this.myMap.geoObjects.add(squarePlacemark);*/
                ...
                jQuery.getJSON('data/data.json', function (json) {
                    ...
                    this.myMap.setBounds(polyline.geometry.getBounds());
                    polyline.options.visible = false;
                    ...
                    //this.myMap.setBounds(myPolyline.geometry.getBounds());
                }.bind(this));
        ...
        renderGeoObjects: function(geoObjects)
        {
            ...
            var myPolyline  = new ymaps.Polyline(geoObjects[0].geometry.coordinates, {
                    /* Свойства линии:
                     - балун ломаной */
                    balloonContent: geoObjects[0].properties.description
                }, {
                    /* Опции линии:
                     - отключение кнопки закрытия балуна */
                    balloonCloseButton: true,
                    ...
                    strokeColor: "0000FF55",
                    // - ширина линии
                    strokeWidth: geoObjects[0].properties['stroke-width']
                }
            );
